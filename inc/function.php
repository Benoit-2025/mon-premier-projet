...
function deleteFrom($id,$table){
 ...
 return $result;
   ...
   /**
     * Pour choisir si on utilise prepare ou execute il faut regarder la requête SQL. 
     *  Si dans ma requête j'ai donnée qui peuvent être envoyées par l'utilisateur ($_POST ou $_GET) j'utilise le prepare/execute. 
