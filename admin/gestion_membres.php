...
<?php if( !isAdmin() ){ // quand on  est pas admin on a pas droit  à la connection profil
        header("location:".URL."profil.php");
        exit;
}
 //

 //GESTION DE LA suppresion de  DES DONNES
 ...
 if( isset($_GET['action']) && $_GET['action'] === "supprimer" )
 {
    ...
    deleteFrom($_GET['id_membre'], 'membre');
...
//récupération du membre selectionner
...
//gestion de récupération des données
        ...
        <!-- Tableau des membres -->
            <table class="table text-center mt-5">
                ...
                <tbody>
                    ...
                    <?php } ?>
                    <!-- grace à $membre , essayez  d'afficher les données dans le tableau -->
...
<form action="" method="POST" class="d-flex flex-wrap">
    ...
    <div class="form-group col-6 px-3">
        <input class="form-control mt-3" type="text" name="prenom" id="prenom" placeholder="Votre Prenom" value="<?= $membreSelected['prenom'] ?>">
        <div class="invalid-feedback"></div> 
    </div>

    <div class="form-group col-6 px-3">
        <input class="form-control mt-3" type="text" name="nom" id="nom" placeholder="Votre Nom" value="<?= $membreSelected['nom'] ?>">
        <div class="invalid-feedback"></div> 
    </div>

    <div class="form-group col-6 px-3">
        <input class="form-control mt-3" type="email" name="email" id="email" placeholder="Votre Email" value="<?= $membreSelected['email'] ?>">
        <div class="invalid-feedback"></div> 
    </div>
