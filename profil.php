...
if( !isConnected() ){
    header("location:connexion.php");// Il doit toujour etre en haut de mon code
    //ce header est toujour appeler avent le html.
    exit;
}
            ...
            <div class="row m-l-0 m-r-0">
                <div class="col-sm-4 bg-c-lite-green user-profile">
                    <div class="card-block text-center text-white">
                        ...
                        <h6 class="f-w-600"><?= $_SESSION['membre']['prenom'] . " " . $_SESSION['membre']['prenom'] ?></h6>
